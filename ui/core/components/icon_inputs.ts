...
export function makeTristateDebuffInput<SpecType extends Spec>(config: TristateInputConfig<Debuffs, Raid>): InputHelpers.TypedIconPickerConfig<Player<SpecType>, number> {
