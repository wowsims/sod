...
const valueKindFactories: { [f in NonNullable<APLValueKind>]: ValueKindConfig<APLValueImplTypesUnion[f]> } = {
	...
	hunterPetIsActive: inputBuilder({
		label: 'Pet is Active',
		submenu: ['Hunter'],
		shortDescription: 'Returns <b>True</b> if the Hunter has a pet active.',
		newValue: APLValueHunterPetIsActive.create,
		includeIf: (player: Player<any>, _isPrepull: boolean) => player.getClass() === Class.ClassHunter,
		fields: [],
	}),
	hunterCurrentPetFocus: inputBuilder({
		label: 'Pet Focus',
		submenu: ['Hunter'],
		shortDescription: 'Amount of currently available pet focus.',
		newValue: APLValueHunterCurrentPetFocus.create,
		includeIf: (player: Player<any>, _isPrepull: boolean) => player.getClass() === Class.ClassHunter,
		fields: [],
	}),
	hunterCurrentPetFocusPercent: inputBuilder({
		label: 'Pet Focus (%)',
		submenu: ['Hunter'],
		shortDescription: 'Amount of currently available pet focus, as a percentage.',
		newValue: APLValueHunterCurrentPetFocusPercent.create,
		includeIf: (player: Player<any>, _isPrepull: boolean) => player.getClass() === Class.ClassHunter,
		fields: [],
	}),
};
