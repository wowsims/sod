...
import P4DaggerGear from './gear_sets/p4_dagger.gear.json';
...
export const P4GearDagger = PresetUtils.makePresetGear('P4 Dagger', P4DaggerGear, { customCondition: player => player.getLevel() == 60 });
...
export const GearPresets = {
	...
	[Phase.Phase4]: [P4GearDagger, P4GearSaber],
	[Phase.Phase5]: [],
};
...
export const ROTATION_PRESET_SLAUGHTER_CUTTHROAT_DPS_60 = PresetUtils.makePresetAPLRotation('P4 Slaughter and Cutthroat', SlaughterCutthroatDPSAPL60, {
	customCondition: player => player.getLevel() == 60,
});
...
export const P4TalentsMuti = PresetUtils.makePresetTalents('P4 Mutilate', SavedTalents.create({ talentsString: '00532310155104-02330520000501' }), {
	customCondition: player => player.getLevel() == 60,
});
...
export const P4TalentsSaber = PresetUtils.makePresetTalents('P4 Saber', SavedTalents.create({ talentsString: '00532310155104-02330520000501' }), {
	customCondition: player => player.getLevel() == 60,
});
...
export const TalentPresets = {
	...
	[Phase.Phase4]: [P4TalentsMuti, P4TalentsSlaughter, P4TalentsSaber],
	[Phase.Phase5]: [P4TalentsMuti, P4TalentsSlaughter, P4TalentsSaber],
};
