...
const SPEC_CONFIG = registerSpecConfig(Spec.SpecRetributionPaladin, {
	...
	otherInputs: {
		inputs: [OtherInputs.ReactionTime, OtherInputs.TankAssignment, OtherInputs.InFrontOfTarget, RetributionPaladinInputs.CrusaderStrikeStopAttack, RetributionPaladinInputs.JudgementStopAttack, RetributionPaladinInputs.DivineStormStopAttack],
	},
	encounterPicker: {
