...
func (paladin *Paladin) applySealOfRighteousnessSpellAndAuraBaseConfig(rank int) {
	...
	onJudgementProc := paladin.RegisterSpell(core.SpellConfig{
		...
		ApplyEffects: func(sim *core.Simulation, target *core.Unit, spell *core.Spell) {
			baseDamage := sim.Roll(baseJoRMinDamage, baseJoRMaxDamage)*impSoRModifier + jorBonusCoefficient*spell.SpellDamage()
	...
	onSwingProc := paladin.RegisterSpell(core.SpellConfig{
		...
		ApplyEffects: func(sim *core.Simulation, target *core.Unit, spell *core.Spell) {
			...
			baseDamage := baseSoRDamage*impSoRModifier + effectBonusCoefficient*spell.SpellDamage()*handednessModifierSP
