...
func applyBuffEffects(agent Agent, playerFaction proto.Faction, raidBuffs *proto.RaidBuffs, partyBuffs *proto.PartyBuffs, individualBuffs *proto.IndividualBuffs) {
	...
	*/
	...
	if raidBuffs.AtieshHealingBuff {
		AtieshHealingEffect(&character.Unit)
	}
	if raidBuffs.AtieshSpellCritBuff {
		AtieshSpellCritEffect(&character.Unit)
	}
	if raidBuffs.AtieshSpellPowerBuff {
...
func DefendersResolveSpellDamage(character *Character, spellDamageAmount int32) *Aura {
	return character.GetOrRegisterAura(Aura{
